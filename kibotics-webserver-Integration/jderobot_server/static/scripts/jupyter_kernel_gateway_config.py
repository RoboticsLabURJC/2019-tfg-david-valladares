...
#c.KernelGatewayApp.auth_token = u''
...
c.KernelGatewayApp.env_process_whitelist=["LD_LIBRARY_PATH", "ROS_ROOT", "ROS_PACKAGE", "ROS_MASTER", "ROS_MASTER_URI", "ROS_DISTRO", "ROS_ETC_DIR", "PYTHONPATH", "ROS_PACKAGE_PATH", "ROS_PYTHON_LOG_CONFIG_FILE", "GAZEBO_MASTER_URI", "PATH", "PKG_CONFIG_PATH", "CMAKE_PREFIX_PATH", "HOME", "GAZEBO_PLUGIN_PATH", "GAZEBO_MODEL_PATH", "GAZEBO_RESOURCE_PATH", "DISPLAY", "JDEROBOT_SIMULATION_TYPE"]
